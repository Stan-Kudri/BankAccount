...
namespace Test
{
    public class PaymentBankTransactionTest
    {
        ...
        public void Make_payment_transaction_of_bank_account(int balance, Money withdrawAmoun, Money putAmounMoney, int firstAccountBalance, int secondAccountBalance)
        {
